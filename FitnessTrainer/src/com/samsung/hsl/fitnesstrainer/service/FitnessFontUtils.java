...
public class FitnessFontUtils {
	...
	public static void setFont(Context context, TextView view) {
		...
		case R.id.fitness_top_bar_title_textview:
			...
			break;
		//회원가입
		case R.id.fitness_top_bar_right_textview:
		...
		case R.id.fitness_slide_menu_user_list_textview:
		case R.id.fitness_slide_start_textview:
		case R.id.fitness_slide_end_textview:
			if(Locale.getDefault().getDisplayLanguage().equals(language_ko))font = NotoSans_Bold;
			else font = Roboto_Bold;
			break;
		//목표 관리
		...
		case R.id.fitness_aim_manager_level4_range_textview:
			...
			break;
		//강사용 메인 화면
		case R.id.fitness_trainer_main_item_name:
		case R.id.fitness_trainer_main_item_heartrate_value:
		case R.id.fitness_trainer_main_item_calorie:
		case R.id.fitness_trainer_main_item_skin_temperature:
		case R.id.fitness_trainer_main_item_state:
		case R.id.fitness_trainer_main_item_device_battery_text:
		case R.id.fitness_trainer_main_item_device_version:
		case R.id.fitness_trainer_main_item_device_name:
			if(Locale.getDefault().getDisplayLanguage().equals(language_ko))font = NotoSans_Bold;
			else font = Roboto_Bold;
			break;
		//강사용 회원 관리
		case R.id.fitness_trainer_user_list_item_name:
		case R.id.fitness_trainer_user_list_item_email:
		case R.id.fitness_trainer_user_board_time:
			if(Locale.getDefault().getDisplayLanguage().equals(language_ko))font = NotoSans_Bold;
			else font = Roboto_Bold;
			break;
		//강사용 회원 보드
		case R.id.fitness_trainer_user_board_name:
		case R.id.fitness_trainer_user_board_birth_height_weight:
			if(Locale.getDefault().getDisplayLanguage().equals(language_ko))font = NotoSans_Bold;
			else font = Roboto_Bold;
			break;
