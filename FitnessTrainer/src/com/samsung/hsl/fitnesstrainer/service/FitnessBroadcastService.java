...
public class FitnessBroadcastService {
	...
	/** @brief 운동이 시작될때 생기는 브로드캐스트 */
	public static final String BROADCAST_START_EXERCISE = "com.samsung.hsl.fitness.start.exercise";
	/** @brief 운동이 끝날때 때 생기는 브로드캐스트 */
	public static final String BROADCAST_END_EXERCISE = "com.samsung.hsl.fitness.end.exercise";
	...
	String[] mBroadcastList = {
			...
			BROADCAST_START_EXERCISE,
			BROADCAST_END_EXERCISE
	};
