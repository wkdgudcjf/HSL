...
public class FitnessWifiProcessClient extends Thread {
	...
	FitnessTrainerService mIFitnessService;
	...
	public FitnessWifiProcessClient(FitnessTrainerService service, FitnessDevice device,IFitnessCommManager.onDeviceListener listener){
