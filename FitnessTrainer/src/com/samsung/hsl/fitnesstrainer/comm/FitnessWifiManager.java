...
import com.samsung.hsl.fitnesstrainer.service.FitnessTrainerService.MODE;
...
public class FitnessWifiManager implements IFitnessCommManager {
	...
	public FitnessWifiManager(FitnessTrainerService service,IFitnessCommManager.onDeviceListener listener) {
		mFitnessService = service;
		mFitnessNsdManager = new FitnessNsdManager(service);
		mOnDeviceListener = listener;
		if(service.getServiceMode()==FitnessTrainerService.MODE.USER)
	...
	IFitnessCommManager.onDeviceListener mOnManagerListener = new onDeviceListener() {
		...
		public void onDeviceDisconnected(FitnessDevice device) {
			...
			if(mFitnessService.getServiceMode()==FitnessTrainerService.MODE.TRAINTER){
