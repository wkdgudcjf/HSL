...
import com.samsung.hsl.fitnesstrainer.sqlite.FitnessBLE;
...
public class FitnessBluetoothGattCallback extends BluetoothGattCallback {
	...
	public FitnessBluetoothGattCallback(FitnessTrainerService service,FitnessDevice data)
	{
	...
	// 데이터를 받았을때 나오는 메소드.
	public void reciveFitnessData(byte[] data) 
	{
