...
public class FitnessTrainerSignUpActivity extends FitnessFontActivity implements OnClickListener {
	private static final String tag = FitnessTrainerSignUpActivity.class.getName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_fitness_trainer_sign_up);
	...
	void signUp(){
		...
		FitnessSQLiteManager db = ((FitnessTrainerApplication) getApplication()).getSQLiteManager();
		User user = new User();
