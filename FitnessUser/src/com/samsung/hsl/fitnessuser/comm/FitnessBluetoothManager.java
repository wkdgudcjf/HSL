...
public class FitnessBluetoothManager implements IFitnessCommManager {
	...
	private FitnessUserService mFitnessService;
	...
	@SuppressLint("NewApi")
	public FitnessBluetoothManager(FitnessUserService service, onDeviceListener listener)
	{
...
*/
        ...
        FitnessBluetoothGattCallback mGattCallback = new FitnessBluetoothGattCallback(mFitnessService,device,isTest);
